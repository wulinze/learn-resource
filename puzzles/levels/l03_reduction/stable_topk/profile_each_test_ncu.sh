...
TEST_FILE="${SCRIPT_DIR}/test_stable_topk.py"
REL_TEST_FILE="${TEST_FILE#${REPO_ROOT}/}"

PYTHON_BIN="${PYTHON_BIN:-python}"
OUTPUT_DIR="${OUTPUT_DIR:-ncu-reports/puzzles/l03_reduction/stable_topk}"
NCU_SET="${NCU_SET:-basic}"
NCU_LAUNCH_COUNT="${NCU_LAUNCH_COUNT:-1}"
NCU_LAUNCH_SKIP="${NCU_LAUNCH_SKIP:-0}"
NCU_KERNEL_NAME="${NCU_KERNEL_NAME:-regex:topk_gate}"
